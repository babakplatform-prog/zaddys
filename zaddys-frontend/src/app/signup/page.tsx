...
export default function SignupPage() {
  ...
  const labelStyles = "text-[13px] text-zinc-300 font-medium";
  ...
  return (
    <main className="min-h-[100dvh] bg-[#0D0D0D] px-5 py-6 font-sans flex flex-col mx-auto max-w-md w-full relative overflow-y-auto pb-safe">
      ...
      <div className="mb-6">
        <h1 className="text-[26px] font-bold text-white mb-1.5 tracking-tight">Sign up with your email</h1>
        <p className="text-zinc-400 text-[15px]">Enter your email to sign up to Zaddys</p>
      </div>
